                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="bg-gray-100 p-6 flex flex-col justify-between">
                        <div>
                            ...
                            <p className="text-gray-700 mb-2">Nous sommes à votre disposition pour toute question :</p>
                            <p className="text-gray-700">
                                <strong>Adresse :</strong> 123 Avenue de la Pizza, Paris, France
                            </p>
                            <p className="text-gray-700">
                                <strong>Téléphone :</strong>{" "}
                                <a href="tel:+33123456789" className="text-orange-500 hover:underline">
                                    01 23 45 67 89
                                </a>
                            </p>
                            <p className="text-gray-700">
                                <strong>Email :</strong>{" "}
                                <a href="mailto:contact@pizzeria.com" className="text-orange-500 hover:underline">
