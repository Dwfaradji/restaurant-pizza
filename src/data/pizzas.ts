...
const cardTomate: Pizza[] = [
  {
    ...
    base: 'Tomate',
    ingredients:
      "Tomate, Mozzarella, Basilic, Huile d'olive, Parmesan, Sel, Poivre",
    dimensions: 'grande (12 x 12 cm), medio (8 x 8 cm), chico (5 x 5 cm)',
    review:
      "J'adore cette pizzas ! Elle est délicieuse, la pâte est parfaite et les ingrédients sont frais. Je la recommande vivement.",
    nutrition: {
      calories: 250,
      fat: '10g',
      carbohydrates: '30g',
  ...
  },
  {
    ...
    dimensions: 'grande (12 x 12 cm), medio (8 x 8 cm), chico (5 x 5 cm)',
    review:
      'Parfaite pour ceux qui aiment un peu de piquant ! Le pepperoni est savoureux et se marie bien avec la sauce tomate.',
    nutrition: {
      calories: 350,
      fat: '15g',
      carbohydrates: '40g',
  ...
  },
  {
    ...
    base: 'Tomate',
    ingredients:
      'Tomate, Mozzarella, Poivrons, Olives, Champignons, Oignons, Basilic',
    dimensions: 'grande (12 x 12 cm), medio (8 x 8 cm), chico (5 x 5 cm)',
    review:
      "C'est la meilleure pizzas pour les végétariens ! Les légumes frais se mélangent parfaitement avec la sauce tomate pour un goût incroyable.",
    nutrition: {
      calories: 280,
      fat: '11g',
      carbohydrates: '35g',
  ...
  },
  {
    ...
    base: 'Tomate',
    ingredients:
      'Tomate, Mozzarella, Poulet grillé, Oignon rouge, Sauce BBQ, Coriandre',
    dimensions: 'grande (12 x 12 cm), medio (8 x 8 cm), chico (5 x 5 cm)',
    review:
      'Une pizzas unique avec des saveurs fumées et du poulet tendre. Le mélange de sauce BBQ et tomate est un incontournable.',
    nutrition: {
      calories: 400,
      fat: '20g',
      carbohydrates: '38g',
  ...
  },
  {
    ...
    base: 'Tomate',
    ingredients:
      'Tomate, Mozzarella, Champignons, Olives, Jambon, Artichauts, Origan',
    dimensions: 'grande (12 x 12 cm), medio (8 x 8 cm), chico (5 x 5 cm)',
    review:
      'Une excellente manière de goûter aux saisons avec chaque part ! Les garnitures sont diverses et la sauce tomate équilibre parfaitement le tout.',
    nutrition: {
      calories: 350,
      fat: '18g',
      carbohydrates: '32g',
...
const cardCream: Pizza[] = [
  {
    ...
    dimensions: 'grande (12 x 12 cm), medio (8 x 8 cm), chico (5 x 5 cm)',
    review:
      'Une pizzas crémeuse et savoureuse avec du bacon croustillant et des champignons. Parfaite pour ceux qui aiment les saveurs riches !',
    nutrition: {
      calories: 450,
      fat: '22g',
      carbohydrates: '35g',
  ...
  },
  {
    ...
    base: 'Crème fraîche',
    ingredients:
      'Crème fraîche, Mozzarella, Pancetta, Parmesan, Œufs, Poivre noir',
    dimensions: 'grande (12 x 12 cm), medio (8 x 8 cm), chico (5 x 5 cm)',
    review:
      'Une pizzas crémeuse et indulgente qui ressemble au plat de pâtes carbonara classique. Absolument délicieuse !',
    nutrition: {
      calories: 500,
      fat: '25g',
      carbohydrates: '40g',
  ...
  },
  {
    ...
    base: 'Crème fraîche',
    ingredients:
      'Crème fraîche, Mozzarella, Poulet grillé, Champignons, Thym, Ail',
    dimensions: 'grande (12 x 12 cm), medio (8 x 8 cm), chico (5 x 5 cm)',
    review:
      'La combinaison parfaite de poulet tendre et de champignons terreux avec une base crémeuse. À essayer absolument !',
    nutrition: {
      calories: 420,
      fat: '18g',
      carbohydrates: '35g',
  ...
  },
  {
    ...
    base: 'Crème fraîche',
    ingredients:
      'Crème fraîche, Mozzarella, Fromage de chèvre, Gorgonzola, Parmesan, Ail',
    dimensions: 'grande (12 x 12 cm), medio (8 x 8 cm), chico (5 x 5 cm)',
    review:
      'Un rêve pour les amateurs de fromage. La base crémeuse avec les quatre fromages différents rend cette pizzas irrésistible !',
    nutrition: {
      calories: 550,
      fat: '30g',
      carbohydrates: '40g',
  ...
  },
  {
    ...
    base: 'Crème fraîche',
    ingredients:
      'Crème fraîche, Mozzarella, Saumon fumé, Aneth, Citron, Câpres',
    dimensions: 'grande (12 x 12 cm), medio (8 x 8 cm), chico (5 x 5 cm)',
    review:
      "La combinaison de saumon fumé et de base crémeuse est luxueuse, et l'aneth et le citron ajoutent un équilibre rafraîchissant.",
    nutrition: {
      calories: 600,
      fat: '35g',
      carbohydrates: '40g',
